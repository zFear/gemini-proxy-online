  ...
  "dictionaries": [
    {
      ...
      "terms": ["список  всех услуг, найденных на сайте компании"]
    },
    {
      "title": "Конкуренты",
    ...
    },
    {
      ...
      "terms": ["список из 50-100 (лучше максимум) важных технических терминов, найденных на всех сайтах"]
    },
    {
      "title": "Причины Обращения (Проблемы)",
      "description": "Фразы, описывающие, зачем клиенты могут звонить.",
      "terms": ["список 50-100 фраз, например 'рассчитать стоимость', 'получить консультацию', 'снять замечания'"]
    }
  ]
}
