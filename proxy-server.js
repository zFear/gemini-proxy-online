...
1.  **Для генерации словарей (type: 'dictionaries'):**
    ...
    {
      "dictionaries": [
        { "title": "Наши услуги", "description": "Все услуги, которые предлагает компания и (или) компания конкурент.", "terms": ["Список услуг"] },
        ...
        { "title": "Возможные причины обращения", "description": "Фразы, описывающие, зачем клиенты могут звонить. Или компания может звонить клиентам", "terms": ["список фраз"] }
      ]
    }
...
2.  **Для генерации контекста бизнеса (type: 'business_context'):**
    ...
    Описание должно быть в пределах 5-10 предложений. Оно должно быть информативным, но лаконичным, фокусируясь на ключевых аспектах и УСЛУГАХ деятельности компании. Не надо писать местоположение компании и другую юридическую информацию сфокусироваться только на предостовляемых услугах  
